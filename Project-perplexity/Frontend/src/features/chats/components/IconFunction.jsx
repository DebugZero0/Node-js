...
export function SearchGlassIcon({ className }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
...
/** Pin icon — outline when unpinned, filled + rotated when pinned */
export function PinIcon({ className, pinned = false }) {
  return (
    <svg viewBox="0 0 24 24" fill="none" className={className} aria-hidden="true">
      {pinned ? (
        <>
          {/* filled tack shape */}
          <path
            d="M16 3H8l-1 7 4.5 2.5V21h1v-8.5L17 10l-1-7Z"
            fill="currentColor"
            stroke="currentColor"
            strokeWidth="1.4"
            strokeLinejoin="round"
            strokeLinecap="round"
          />
          <line x1="12" y1="10" x2="12" y2="10" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" />
        </>
      ) : (
        <>
          <path
            ...
            strokeLinecap="round"
          />
          <line x1="8" y1="10" x2="16" y2="10" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
        </>
      )}
    </svg>
  )
...
export function GlassAvatar({ label, size = "h-10 w-10", text = "text-sm" }) {
  return (
    <span
